...
return{promise:new Ember.RSVP.Promise((function(e,i){t=function(){r=!0,e()},n=i}),e),resolve:t,reject:n,get isResolved(){return r}}}function c(e){try{performance.mark(e)}catch(t){console.warn("performance.mark could not be executed because of ".concat(t.message))}}u()})),define("ember-focus-trap/components/focus-trap",["exports","@glimmer/component","ember-keyboard-shortcuts","ember-app-scheduler","ember-focus-trap/utils/element-is-visible","ember-focus-trap/utils/focusable-elements"],(function(e,t,n,r,i,o){"use strict"
var a,s
