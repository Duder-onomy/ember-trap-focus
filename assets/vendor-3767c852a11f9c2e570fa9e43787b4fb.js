...
r[i]=O(r[i],t,!1)},e.associateDestroyableChild=T,e.isDestroying=j,e.isDestroyed=function(e){return 2===R(e).state}
...
0===n.state&&(n.children=O(n.children,e))}(e,t)})),t.state=2}))}}function M(e){w(R(e).children,N)}function j(e){return R(e).state>=1}e._scheduleDestroyed=x,e.enableDestroyableTracking=S,e.assertDestroyablesDestroyed=P
