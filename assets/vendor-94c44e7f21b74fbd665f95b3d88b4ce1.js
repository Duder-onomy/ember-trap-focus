...
var _,w,E,O,R,T,S=Ember.HTMLBars.template({id:"5kOlYMWi",block:'{"symbols":["&attrs","&default"],"statements":[[11,"div"],[17,1],[4,[38,0],[[32,0,["handleDidInsert"]]],null],[12],[2,"\\n  "],[18,2,null],[2,"\\n"],[13],[2,"\\n"]],"hasEval":false,"upvars":["did-insert"]}',moduleName:"ember-trap-focus/components/focus-trap.hbs"}),k=(a=Ember._action,u=function(e){(function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function")
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&d(e,t)})(b,e)
var t,a,s,u,c,v=m(b)
function b(){var e
p(this,b)
...
var t=this.getAllFocusableChildren(),n=this.getCurrentlyFocusedItem()
if(n){var r=t.indexOf(n)
0!==r?t[r-1]&&t[r-1].focus():t[t.length-1]&&t[t.length-1].focus()}else t[t.length-1].focus()}}])&&h(t.prototype,a),s&&h(t,s),b}(t.default),_=(s=u).prototype,w="handleDidInsert",E=[a],O=Object.getOwnPropertyDescriptor(s.prototype,"handleDidInsert"),R=s.prototype,T={},Object.keys(O).forEach((function(e){T[e]=O[e]})),T.enumerable=!!T.enumerable,T.configurable=!!T.configurable,("value"in T||T.initializer)&&(T.writable=!0),T=E.slice().reverse().reduce((function(e,t){return t(_,w,e)||e}),T),R&&void 0!==T.initializer&&(T.value=T.initializer?T.initializer.call(R):void 0,T.initializer=void 0),void 0===T.initializer&&(Object.defineProperty(_,w,T),T=null),s)
e.default=k,Ember._setComponentTemplate(S,k)})),define("ember-trap-focus/utils/element-is-visible",["exports"],(function(e){"use strict"
