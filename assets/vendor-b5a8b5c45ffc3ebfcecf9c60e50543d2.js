...
for(var n=0,r=new Array(t);n<t;n++)r[n]=e[n]
return r}function f(e,t,n,r,i,o,a){try{var s=e[o](a),u=s.value}catch(l){return void n(l)}s.done?t(u):Promise.resolve(u).then(r,i)}function p(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function h(e,t){for(var n=0;n<t.length;n++){var r=t[n]
...
var _,E,w,O,R,T,k=Ember.HTMLBars.template({id:"Wejmy3+V",block:'{"symbols":["&attrs","&default"],"statements":[[11,"div"],[17,1],[4,[38,0],[[32,0,["handleDidInsert"]]],null],[12],[2,"\\n  "],[18,2,null],[2,"\\n"],[13],[2,"\\n"]],"hasEval":false,"upvars":["did-insert"]}',meta:{moduleName:"ember-trap-focus/components/focus-trap.hbs"}}),A=(a=Ember._action,u=function(e){(function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function")
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&d(e,t)})(y,e)
var t,a,s,u,c,v=m(y)
function y(){var e
p(this,y)
for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r]
return b(g(e=v.call.apply(v,[this].concat(n))),"keyboardShortcuts",{"alt+tab":e.previous,end:e.focusLastItem,home:e.focusFirstItem,"shift+tab":e.previous,down:e.next,tab:e.next,up:e.previous}),b(g(e),"focusTrapContainerElement",null),e}return t=y,(a=[{key:"handleDidInsert",value:(u=regeneratorRuntime.mark((function e(t){return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,(0,r.whenRouteIdle)()
...
var t=this.getAllFocusableChildren(),n=this.getCurrentlyFocusedItem()
if(n){var r=t.indexOf(n)
0!==r?t[r-1]&&t[r-1].focus():t[t.length-1]&&t[t.length-1].focus()}else t[t.length-1].focus()}}])&&h(t.prototype,a),s&&h(t,s),y}(t.default),_=(s=u).prototype,E="handleDidInsert",w=[a],O=Object.getOwnPropertyDescriptor(s.prototype,"handleDidInsert"),R=s.prototype,T={},Object.keys(O).forEach((function(e){T[e]=O[e]})),T.enumerable=!!T.enumerable,T.configurable=!!T.configurable,("value"in T||T.initializer)&&(T.writable=!0),T=w.slice().reverse().reduce((function(e,t){return t(_,E,e)||e}),T),R&&void 0!==T.initializer&&(T.value=T.initializer?T.initializer.call(R):void 0,T.initializer=void 0),void 0===T.initializer&&(Object.defineProperty(_,E,T),T=null),s)
e.default=A,Ember._setComponentTemplate(k,A)})),define("ember-trap-focus/utils/element-is-visible",["exports"],(function(e){"use strict"
